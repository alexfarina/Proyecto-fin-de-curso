...
== Description ==
Quality Orange is the child version of Quality theme.
...
Quality WordPress Theme, Copyright 2014-2024 priyanshumittal
Quality WordPress Theme is distributed under the terms of the GNU GPL

Quality Orange WordPress Theme is a child theme of Quality Theme, Copyright (C) 2015-2024, priyanshumittal
Quality-Orange WordPress Theme is distributed under the terms of the GNU GPL
...
2. Fixed blog setting image size theme check issue.
== 1.2.6 =
1. Changed some customizer strings.
== 1.2.5 =
1. Fixed the theme check warnings.
== 1.2.4 =
1. Fixed the sidebar issue in the responsive view.
== 1.2.3 =
1. Fixed the menu issue in the standard header layout.
2. Fixed classic dark header layout issue in the responsive view. 
== 1.2.2 =
1. Fixed the empty markup issue and site title & tagline issues in iPad view.
2. Fixed the service section design issue.
== 1.2.1 =
1. Added license of theme copyright, mansory js and header radio button image.
2. Added orginial file of mp.mansory.min.js file and changed License & License URI in readme.
= 1.2 =
...
https://pxhere.com/en/photo/1563803
