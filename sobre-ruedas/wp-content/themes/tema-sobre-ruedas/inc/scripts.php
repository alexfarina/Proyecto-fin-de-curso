...
function tema_sobre_ruedas_enqueue_scripts() {
    ...
    wp_enqueue_script('add-to-cart-ajax',get_template_directory_uri() . '/js/anadir-carrito.js',
    ...
    wp_enqueue_script('filtros-ajax',get_template_directory_uri() . '/js/menu-filtros.js',array(),'1.0',true);
